...
PikView jest przeglądarką plików graficznych używającą bibliotek KDE.
Może czytać pliki: png, jpeg, tiff, gif, netpbm (oraz poprzez
bibliotekę ImageMagick: eps, pict, dcx, pcx, mif, bmp, viff, pnm).
Poza tym ma możliwość: preładowania, powiększania, thumbnaili,
wypełniania obrazków, przeglądania pełnoekranowego, drukowania,
